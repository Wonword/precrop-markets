...
export interface PrecropNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface PrecropNFT extends BaseContract {
  connect(runner?: ContractRunner | null): PrecropNFT;
  waitForDeployment(): Promise<this>;

  interface: PrecropNFTInterface;
  ...
  creator: TypedContractMethod<[arg0: BigNumberish], [string], "view">;
